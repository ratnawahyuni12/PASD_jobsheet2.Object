...
jawaban: tidak harus berurutan. metode di dalam class Mahasiswa dapat diakses dalam urutan apapun sesuai kebutuhan, karena setiap method bersifat independen dan tidak bergantung satu sama lain. namun ada pengecualian, yaitu jika logika program mengharuskan urutan tertentu. contohnya pada program ini, updateIPK() sebaiknya dipanggil sebelum tampilkanInformasi() jika ingin menampilkan nilai IPK yang sudah diperbarui. jika urutannya terbalik, program tetap bisa berjalan tapi data yang ditampilkan belum terupdate.